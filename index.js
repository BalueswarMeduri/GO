...
const typed = new Typed('#prompts-sample', {
    strings: ["Daily DSA Quizzes- Boost your problem-sloving skills", 
                "Internships - Stay head with the best career opportunities", 
                "Hackathons Alerts - Showcase you talent and win big!", 
                ],
    typeSpeed: 80,
    smartBackspace: true, 
    loop: true,
...
const typedd = new Typed('#prompts-samplee', {
    strings: ["Internships - Stay head with the best career opportunities", 
                "Hackathons Alerts - Showcase you talent and win big!", 
                "Daily DSA Quizzes- Boost your problem-sloving skills", 
                ],
    typeSpeed: 80,
    smartBackspace: true, 
    loop: true,
...
const typeddd = new Typed('#prompts-sampleee', {
    strings: ["Hackathons Alerts - Showcase you talent and win big!", 
                "Daily DSA Quizzes- Boost your problem-sloving skills", 
                "Internships - Stay head with the best career opportunities", 
               ],
    typeSpeed: 80,
